    ...
    return(
        ...
        <div className="flex w-full justify-between mt-5 items-start border-b border-gray-200 pb-8">
            ...
            <div className="w-[75%] pr-4">
                <p className="font-bold text-gray-800 text-base">{items?.name}</p>
            ...
            <div className="w-[18%] relative shrink-0">
                <img className="w-full h-36 object-cover rounded-2xl" src={"https://media-assets.swiggy.com/swiggy/image/upload/" + items?.imageId}/>
                {
                    count === 0 ?(
