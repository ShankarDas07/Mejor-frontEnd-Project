...
export default function CartCheckout() {
    ...
    return (
        <div className="w-[95%] sm:w-[80%] md:w-[70%] lg:w-[60%] mx-auto mt-6 md:mt-10 px-2 sm:px-0">
            ...
            <div className="flex items-center gap-4 pb-4 border-b border-gray-300">
                ...
                />
                <div>
                    <p className="font-bold text-base md:text-lg">{itemsObj[0]?.restaurant || "Restaurant"}</p>
            ...
            <div className="mt-4">
                {itemsObj.map((item) => (
                    <div key={item.id} className="flex items-center justify-between py-3 md:py-4 border-b border-gray-100 gap-2">
                        <div className="flex items-center gap-3">
                            <span className="text-green-600 text-lg">🟩</span>
                            <p className="text-gray-800 font-medium text-sm md:text-base truncate">{item.name}</p>
                        </div>
            ...
            {/* Bill Details */}
            <div className="mt-6 md:mt-8 bg-white rounded-xl p-4 md:p-6 shadow-sm mb-10">
